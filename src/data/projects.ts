  ...
  en: [
    {
      ...
      description: "Robust backend built with Flask and SQLAlchemy. Implements authentication, order tracking, and notification system with Flask-Mail.",
    ...
    },
    {
      ...
      description: "CRUD for contacts. Uses REST APIs to serve information to the frontend, JWT authentication, and CSV contact export.",
    ...
    {
      id: "sistema-gestion",
      title: "SIGES - Comprehensive School Management System",
      imageFolder: "sistema-gestion",
      description: "Includes modules for procedure generation, student registration, and academic processes like admission. Developed with Django's MVT architecture.",
